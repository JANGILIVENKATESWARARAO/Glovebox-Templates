...
@Component({
  ...
  standalone: true,
  imports: [Header3Component,Banner1Component,FindYourCar1Component,TrustedBrand1Component,Motability2Component,VehicalsServices1Component,AboutParkway1Component,Footer2Component],
