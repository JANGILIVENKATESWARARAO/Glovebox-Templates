...
@Component({
  ...
  standalone: true,
  imports: [Header4Component,HomepageHero1Component,PerfectPartner1Component,UsedCars1Component,Motability3Component,VechicalsServices3Component,AboutParkway4Component,Footer2Component],
